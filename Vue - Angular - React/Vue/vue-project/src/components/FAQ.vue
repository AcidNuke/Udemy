    ...
    <div class="container">
      <section class="section">
        ...
        <h2 class="subtitle is-4">
          Duis feugiat, risus quis rhoncus semper, ligula lorem facilisis risus, non varius nunc enim a dui. Donec elit
          ...
          <div class="column is-one-third" v-for="faq of faqs">
            <div class="card">
              <div class="card-content">
                <p class="title">1{{ faq.title }}</p>
                <p class="answer">2{{ faq.body }}</p>
              </div>
            </div>
          </div>
        </div>
